var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img src="handwashing.gif" alt="How to Handwash" bp="offset-5@md 4@md 12@sm" class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
	...
	<a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound
		Source</a>`;
    			...
    			attr(h1, "class", "svelte-9rz8mj");
    			attr(h3, "class", "svelte-9rz8mj");
    		},
    		m(target, anchor) {
